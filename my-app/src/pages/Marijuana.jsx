...
export default function Marijuana() {
  return (
    <div className='Marijuana'>
      <h1>MARIJUANA</h1>
      <img src={img8} alt="" width="49%"/>
      <img src={img9} alt="" width="51%" />
      <p>
      ...
      <p>In October 2018, marijuana became legal for recreational and medical use in Canada.</p>
      <p>As of July 2021, 18 states, two territories, and the District of Columbia legalized recreational marijuana. A total of 36 states and three territories legalized medical marijuana.</p>
      <p>The global marijuana market was estimated to be worth $21.3 billion in 2020 and is expected to grow to $55.9 billion by 2026.</p>
      <p>This growth is expected to be fueled by an increase in demand (thanks to the increasing degree of legalization around the world) along with a rise in the use of medical marijuana.</p>
      <p>
      ...
      <p>Calvin Broadus, a.k.a. Snoop Dogg, is another notable investor in the industry. The rapper makes no secret of his affinity for marijuana and is the director of Casa Verde Capital, a venture capital fund that invests in cannabis startups.</p>
