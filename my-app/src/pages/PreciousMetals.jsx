...
export default function PreciousMetals() {
  return (
    <div className='PreciousMetals'>
      <h1>Precious Metal</h1>
      <h3>Investing in Precious Metal</h3>
      <p>
      ...
      <h3>Filling up your Treasure Chest</h3>
      <p>Let's take a look at the options available to invest in precious metals with TheFipTrades;</p>
      <h2>GOLD</h2>
